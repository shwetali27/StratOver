...
class MethodTime{
		...
		public void method1(Integer[] array){
				...
				System.out.println("Time is:" +(sp-st)+" miliseconds");
			...
			public void method4(String[] string){
				...
				System.out.println("Array before Sorting:");
				u.printArray(string);
				string = u.insertionSortString(array);
				System.out.println("Array After Sorting:");
				u.printArray(string);
				sp = System.currentTimeMillis();
				System.out.println("Time is:" +(sp-st)+" miliseconds");
			...
			public void method6(String[] string){
				...
				System.out.println("Array before Sorting:");
				u.printArray(string);
				array = u.bubbleSortString(string);
				System.out.println("Array After Sorting:");
				u.printArray(string);
				sp = System.currentTimeMillis();
				System.out.println("Time is:" +(sp-st)+" miliseconds");
	...
	public static void main(String[] args){
		...
		System.out.println("Please Enter Size for an String array");
		int n = u.inputInteger();
